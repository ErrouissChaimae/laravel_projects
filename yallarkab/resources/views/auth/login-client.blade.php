...
<div class="container mt-5">
    <div class="row ">
        ...
        <div class="col-md-6" >
     <h1> <strong>Réservez et découvrez le monde</strong></h5>
   <hr class="mini-hr">

            <img src="/images/lc.png" class="img-fluid" alt="Logo" width="500px" style="margin-top: -40px;">
        </div>
                ...
                <div class="card-header" >
                    <h4 class="text-center" style="color: rgb(255, 147, 64)">
                        <strong>
                            ...
                            </svg>  {{ __('Authentification Client') }}
                        </strong>
                    </h4>
                </div>
