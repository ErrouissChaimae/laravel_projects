    ...
    <div class="row">
        <div class="container">
            <div class="row">
              ...
              <div class="col-sm-4">
                <form action="{{ route('dashboard.search') }}" method="GET" class="mb-3">
                    <div class="input-group">
                        <input type="text" name="query" class="form-control" placeholder="Search by name or CIN" required style="border-radius: 20px">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('Address') }}</th>
                                <th>{{ __('CIN') }}</th>
                                <th>{{ __('Actions') }}</th> <!-- New column for actions -->
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Edit link -->
                                    <a href="{{ route('admin.edit', $user->id) }}"class="edit-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
