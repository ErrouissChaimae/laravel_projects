    ...
    <div class="container-fluid" style="width: 80%">   
        <div class="row">
            <div class="col-md-6">
                ...
                <img src="/images/da.png" style="width: 100%;margin-top:5%">

            </div>
            <div class="card col-md-6" >
                <div class="card-header">Modifier Profil</div>
                <div class="card-body">
                    <form action="{{ route('profile.update',$user->id_pers) }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="cin">CIN:</label>
                            <input type="text" id="cin" name="cin" class="form-control" value="{{ $user->cin }}" required>
                            @if ($errors->has('cin'))
                            ...
                            <input type="text" id="tel" name="tel" class="form-control" value="{{ $user->tel }}" required>
                            @if ($errors->has('tel'))
                        ...
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-register">Mettre à jour</button>
                            <a class="btn btn" style="background-color: #ccd5ae;" href="{{route('profile.show')}}">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
